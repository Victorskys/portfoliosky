...
<b>Требования к продукту</b>: обеспечить функционирование раздела "Видеопрактика".<br>
  У преподавателей должна быть иметь возможность провести урок с использованием веб-приложения  Skyeng, а у учеников должна быть возможность подключиться на видеоурок с использованием мобильного приложения Skyeng<br></p>
<p>Что нужно было сделать: 
<ol>
