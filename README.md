...
2)Была подготовлена тестовая документация для нескольких видов тестирования<br>
  <ol>
    <li>Функциональное</li> <img src="https://github.com/Victorskys/portfoliosky/blob/main/%D1%80%D1%80.JPG">
      
Проведено несколько видов тестирования (приёмочное, функциональное, smoke тестирование, регрессивное тестирование)
