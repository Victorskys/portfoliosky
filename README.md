...
- Владение системами хранения документации: Jira, Confluence, Trello, Qase.io, Sitechko, Miro;
- Работа с БД: pgAdmin, практические навыки работы с SQL;
- Опыт тестирования мобильных приложений: практические навыки работы с Android Studio;
...
- Являлся старостой группы при тестировании мобильного приложения Skyeng
</li>
<br>
...
<p>У преподавателей должна быть возможность провести урок с использованием веб-приложения  Skyeng, а у учеников должна быть возможность подключиться на видеоурок с использованием мобильного приложения Skyeng.</p>
<br></p>
<p>Что нужно было сделать: 
<ol>
...
<br>
Более подробную информацию о проверках и отчетах можно посмотреть тут<br>
<a href="https://vicqasky.atlassian.net/wiki/spaces/~6369d8a2d60bd2b365f881dd/pages/33291">Ссылка на проект</a><br>

Во время проведения тестирования было проведено 64 проверки с использованием таких инструментов как:<br>
<ul>
...
Был обнаружен ряд багов и составлен отчёт о проведённом тестировании.<br>
Подробнее можно посмотреть тут<br>
<a href="https://vicqasky.atlassian.net/wiki/spaces/~6369d8a2d60bd2b365f881dd/pages/33299">Ссылка на отчет</a><br>
...
<ul>
  ...
  <li>Проводить тестирование мобильного приложения</li>
</ul>
